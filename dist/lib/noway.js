...
const userLogin = {
    ...
    view: function () {
        ...
        return m("div", {"class":"flex min-h-full flex-col justify-center px-6 py-12 lg:px-8"},
        [
          m("div", {"class":"sm:mx-auto sm:w-full sm:max-w-sm"},
            [
              m("img", {"class":"mx-auto h-50 w-auto","src":"/img/ven.png","alt":"Your Company"}),
              m("h2", {"class":"mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900"}, 
          ...
          m("div", {"class":"mt-10 sm:mx-auto sm:w-full sm:max-w-sm"},
            [
              m("form", {"class":"space-y-6","action":"#","method":"POST"},
                [
                  m("div",
                    [
                      m("label", {"class":"block text-sm font-medium leading-6 text-gray-900","for":"fname"}, 
                        "Full Name"
                      ),
                      m("div", {"class":"mt-2"}, 
                        m("input", {"class":inputClassDefault,"id":"fname","name":"fname","type":"text", "required":"required", onblur:(e)=>{
                  ...
                  m("div",
                  [
                    m("label", {"class":"block text-sm font-medium leading-6 text-gray-900","for":"uname"}, 
                      "User Name"
                    ),
                    m("div", {"class":"mt-2"}, 
                      m("input", {"class":inputClassDefault,"id":"uname","name":"uname","type":"text", "required":"required", onblur:(e)=>{
                  ...
                  [
                    ...
                    m("div", {"class":"mt-2"}, 
                      m("input", {"class":inputClassDefault,"id":"email","name":"email","type":"email","autocomplete":"email","required":"required", onblur:(e)=>{
                ...
                [
                  ...
                  m("div", {"class":"mt-2"}, 
                    m("input", {"class":inputClassDefault,"id":"pwd1","name":"pwd1","type":"password", "required":"required", onblur:(e)=>{
              ...
              [
                ...
                m("div", {"class":"mt-2"}, 
                  m("input", {"class":inputClassDefault,"id":"pwd2","name":"pwd2","type":"password", "required":"required", onblur:(e)=>{
            ...
            [
              ...
              m("div", {"class":"mt-2"}, 
                m("input", {"class":inputClassDefault,"id":"secret","name":"secret","type":"password", "required":"required", onblur:(e)=>{
                  ...
                  m("div", 
                    m("button", {"class":"flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600","type":"submit"}, 
                      "Submit"
                    )
                  )
                ]
